                ...
                <div class="form-group d-flex flex-column">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="email" name="email"
                            <?php if (get_checkbox_value('email') === '1') echo 'checked'; ?> />
                    ...
                    <div class="form-check mt-2">
                        <input class="form-check-input" type="checkbox" id="gdpr" name="gdpr"
                            <?php if (get_checkbox_value('gdpr') === '1') echo 'checked'; ?> />
                    ...
                    <div class="form-check mt-2">
                        <input class="form-check-input" type="checkbox" id="clear_data" name="clear_data"
                            <?php if (get_checkbox_value('clear_data') === '1') echo 'checked'; ?> />
