    ...
    <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg">
        <div class="container-fluid py-4">
            <div class="py-4">
                <div class="row">
                    <div class="col-12">
                        <h6 class="fw-bolder w-50 m-0 p-0 mb-4">Archived Surveys</h6>
                                ...
                                <table class="table align-items-center mb-0 m-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id="survey_data" data-card-id=<?php echo $poll->poll_id; ?>>
                                            ...
                                            <td
                                                class="text-center d-flex align-items-center justify-content-center px-0 p-4 gap-lg-3 gap-md-2 gap-1">
                                                <i id="restore_btn" class="restoreButton fas fa-undo text-sm text-dark"
                                                    style="cursor: pointer"></i>

                                                <i id="delete_btn" style="cursor: pointer"
                                                    class="deleteButton fas fa-trash text-sm text-danger"
                                                    data-card-id=<?php echo $poll->poll_id; ?> data-bs-toggle="modal"
