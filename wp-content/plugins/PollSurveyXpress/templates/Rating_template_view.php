...
<body class="g-sidenav-show bg-gray-100">
    <main class="main-content position-relative max-height-vh-100 h-100 mt-4 border-radius-lg">
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl"  >
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <h6 class="font-weight-bolder mb-0">Rating Template View</h6>
                </nav>
            </div>
        </nav>
        ...
        <div class="mt-4 p-4">
            <h4 class="mb-4 align-self-start p-0">Survey Title</h4>

            <div class="d-flex flex-column align-items-start my-3 p-4 rounded-3 border bg-white">
                <div class="d-flex justify-content-between align-items-center w-100 mb-3">
                    <h5 class="w-100 text-lg mb-4">Pull/Survey title</h5>

                    <div id="rateInputs"
                        class="form-check d-flex justify-content-around align-items-center col-8 gap-2">
                        <p class="w-100 mb-4 fw-bold text-center">Rate #1</p>
                        <p class="w-100 mb-4 fw-bold text-center">Rate #2</p>
                        <p class="w-100 mb-4 fw-bold text-center">Rate #3</p>
                        <p class="w-100 mb-4 fw-bold text-center">Rate #4</p>
                        <p class="w-100 mb-4 fw-bold text-center">Rate #5</p>
                    </div>
                </div>

                <div id="questionsGroup" class="flex flex-column gap-2 w-100">
                    <div class="d-flex justify-content-between align-items-center w-100 mb-1">
                        <h5 class="fw-bold">faw</h5>
                        <div class="form-check d-flex justify-content-around align-items-center col-8">
                            <input class="form-check-input m-0" type="radio" name="radioGroup_${counter}" id="radio1" />
                            <input class="form-check-input m-0" type="radio" name="radioGroup_${counter}" id="radio2" />
                            <input class="form-check-input m-0" type="radio" name="radioGroup_${counter}" id="radio3" />
                            <input class="form-check-input m-0" type="radio" name="radioGroup_${counter}" id="radio4" />
                            <input class="form-check-input m-0" type="radio" name="radioGroup_${counter}" id="radio5" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body d-flex flex-column gap-2">
                    ...
                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input m-0" type="radio" name="radioGroup" id="radio1" />
                        <input type="text" class="form-control" id="surveyTitle" placeholder="Option title #1" />
                    </div>

                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input m-0" type="radio" name="radioGroup" id="radio2" />
                        <input type="text" class="form-control" placeholder="Option title #2" />
                    </div>

                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input m-0" type="radio" name="radioGroup" id="radio3" />
                        <input type="text" class="form-control" placeholder="Option title #3" />
                    </div>

                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input m-0" type="radio" name="radioGroup" id="radio4" />
