...
<body class="g-sidenav-show bg-gray-100">
    <main
        ...
        <nav class="px-0 mb-6 shadow-none border-radius-xl" navbar-scroll="true">
            <nav aria-label="breadcrumb">
                <h6 class="font-weight-bolder mb-0">Rating Template Edit</h6>
            </nav>
        </nav>
                ...
                <div class="p-4 pt-3">
                    <div class="mb-2">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <input type="text" class="form-control" id="optionInput" placeholder="Option title" />
                            <button id="addOption"
    ...
    rateInputs.forEach((input, index) => {
        ...
        console.log("Rates Array before inputting", ratesArray);
