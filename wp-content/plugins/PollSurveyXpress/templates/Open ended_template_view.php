...
<html lang="en">
  ...
  <body class="g-sidenav-show bg-gray-100">
    <main
      class="main-content position-relative max-height-vh-100 h-100 mt-4 border-radius-lg"
    >
      ...
      <div class="container-fluid py-4">
        <div class="row mt-4">
          ...
          <div class="col-lg-7 m-0">
            <div class="card w-100 z-index-2">
    ...
    ?>
    <div class="col" >
            <div class="card m-0 p-4 rounded-3 border">
                <p>
