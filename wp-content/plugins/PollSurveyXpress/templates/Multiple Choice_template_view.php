...
<body class="g-sidenav-show bg-gray-100">
    <main class="main-content position-relative max-height-vh-100 h-100 mt-4 border-radius-lg">
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <h6 class="font-weight-bolder mb-0">Multiple Choice Template View</h6>
                </nav>
            </div>
        </nav>

        <div class="container-fluid py-4 bg-white">
            <div class="row mx-auto row-cols-1 row-cols-lg-2 g-4 mt-4 border rounded-3">
                <div class="col mb-4">
                    <div class="">
        ...
        <div class="mt-6 container-fluid">
            <h4 class="mb-4 align-self-start p-0"> <?php echo ((json_decode(stripslashes($poll_data_json), true)['title'])); ?></h4>

            <div class="row mx-auto row-cols-1 row-cols-lg-2 g-3">
                <?php
                ...
                if ($questions_decoded !== null) {
                    foreach ($questions_decoded as $question) {
                ?>
                        <div class="col">
