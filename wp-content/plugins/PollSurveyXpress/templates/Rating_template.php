...
<body class="g-sidenav-show bg-gray-100">
    <main
        class="col-lg-8 col-md-9 col-10 mx-auto main-content position-relative max-height-vh-100 h-100 mt-4 border-radius-lg">
        <!-- Navbar -->
                ...
                <div class="p-4 pt-3">
                    <div class="mb-2">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <input type="text" class="form-control p-2 border rounded-1" id="questionInput"
        ...
        <div class="d-flex flex-column align-items-start my-3 p-4 rounded-3 border bg-white">
            ...
            <div class="d-flex justify-content-between align-items-center w-100 mb-3">
                ...
                <div id="rateInputs" class="form-check d-flex justify-content-around align-items-center col-8 gap-2">
                    <input type="text" id="rateInput1" class="w-100 text-lgs p-2 px-0 bg-white border-0 rounded-1 mb-4"
                        placeholder="Rate #1" value="Rate #1" />
                    <input type="text" id="rateInput2" class="w-100 text-lgs p-2 px-0 bg-white border-0 rounded-1 mb-4"
                        placeholder="Rate #2" value="Rate #2" />
                    <input type="text" id="rateInput3" class="w-100 text-lgs p-2 px-0 bg-white border-0 rounded-1 mb-4"
                        placeholder="Rate #3" value="Rate #3" />
                    <input type="text" id="rateInput4" class="w-100 text-lgs p-2 px-0 bg-white border-0 rounded-1 mb-4"
                        placeholder="Rate #4" value="Rate #4" />
                    <input type="text" id="rateInput5" class="w-100 text-lgs p-2 px-0 bg-white border-0 rounded-1 mb-4"
                        placeholder="Rate #5" value="Rate #5" />
                </div>
            </div>
