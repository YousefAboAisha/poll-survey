    ...
    <main class="col-lg-8 col-md-9 col-10 mx-auto main-content position-relative max-height-vh-100 h-100 mt-4 border-radius-lg">
        ...
        <div class="d-flex flex-column align-items-start my-3 p-4 rounded-3 border bg-white">
            <div class="d-flex justify-content-between align-items-center w-100 mb-4">
                <input data-json-data="<?php echo ($isItEditPage ? $jsonDataEncoded : '') ?>" type="text" class="w-100 border text-lg rounded-1 p-1 rounded-1 bg-white" placeholder="Poll/Survey title" id="surveyTitle" value="<?php echo ($isItEditPage ? $poll_data[0]->title : '') ?>" data-type="<?php echo ($isItEditPage ? "Edit" : "Add"); ?>" data-form-id="<?php echo ($isItEditPage ? $poll_id : null); ?>" />
                        ...
                        <div class="form-group d-flex flex-column">
                            ...
                            <div class="w-100 d-flex flex-column align-items-start mt-2 gap-2">
                                ...
                                <button onclick="(e)=> e.preventDefault();" id="cta_button" type="button" class="btn btn-dark m-0 mt-1">
                                    <?php echo ($isItEditPage ? ($poll_data[0]->cta_Text != '' ? $poll_data[0]->cta_Text : "Do The Survey Now!") : "Do The Survey Now!"); ?>
                                </button>
