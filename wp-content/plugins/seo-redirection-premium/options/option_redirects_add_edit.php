            ...
            <?php
                ...
                $drop->select($redirect_from_type);
					...
					<span id="dv_rule_replace">
						...
						<a id="invalid_redirect_from" style="display: none;" class="btn btn-danger btn-xs" href="https://wp-buy.com/redirection-kb/why-having-the-red-message-seems-to-be-invalid-click-here.htm" target="_blank"><span class="glyphicon glyphicon-alert" aria-hidden="true"></span> <?php _e('Seems to be invalid, Click here','wsr'); ?></a>
                ...
                <div class="divcontainer" id="dv_from_subfolders">
                    ...
                    <div class="test_inputs_div" style="display:none;">
                        ...
                        <h4><?php _e('RegEx testing box','wsr'); ?>:</h4>
                            ...
                            <a target="_blank" href="https://wp-buy.com/redirection-kb/adding-redirects.htm#ipt_kb_toc_58_5" class="learn_link"><span class="glyphicon glyphicon-question-sign sign_link"></span><?php _e('Learn how to use the regex','wsr'); ?></a>
