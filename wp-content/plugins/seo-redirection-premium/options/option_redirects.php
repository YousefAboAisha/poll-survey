...
<!-- ***** Table  *******************************************************  !-->                
         ...
         <div style="text-align: right"><?php _e(' * Need Help?','wsr'); ?>  <a target="_blank" href="https://wp-buy.com/redirection-kb/adding-redirects.htm"><?php _e('click here to see how to add redirects','wsr'); ?></a></div>
