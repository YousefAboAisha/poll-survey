...
<br/><h4><span class="glyphicon glyphicon-cog"></span> <?php _e(' General Options','wsr') ?></h4><hr/>
    ...
    <div class="form-group">
	 ...
	 <div class="form-group">
        <label class="control-label col-sm-2" for="show_redirect_box"><?php _e(' Search Box:','wsr') ?></label>
        <div class="col-sm-10">
            <div style="margin-top:5px;"><?php $check->create_single_option('never_redirect_search_res',$options->read_option_value('never_redirect_search_res')) ?>	<?php _e('Never redirect search results','wsr')?></div>
        </div>
    </div>
