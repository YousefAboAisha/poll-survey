...
// -- POPUP -------------------------------------------------------
    ...
    <form id="myform" action="" method="post" class="form-horizontal" role="form">
        ...
        <div style="text-align: right"><?php _e('* Too many 404 errors?','wsr'); ?> <a target="_blank" href="https://wp-buy.com/redirection-kb/too-many-404-errors.htm"><?php _e('click here to see why?','wsr'); ?></a></div>
