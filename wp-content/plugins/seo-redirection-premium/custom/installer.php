    ...
    class seo_redirection_installer {
        ...
        public static function install($networkwide)
        {
            ...
            if($wpdb->get_var("show tables like '$table_name'") != $table_name) {
                ...
                PRIMARY KEY (`ID`),
                UNIQUE KEY `redirect_from` (`redirect_from`(200),`cat`,`blog`)
                )ENGINE = MyISAM ;";
                $wpdb->query($sql);
            ...
            }else
            {
                ...
                $wpdb->query("ALTER TABLE $table_name CHANGE `redirect_to` `redirect_to` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL;");
                ...
                if($wpdb->get_var(" SELECT count(*) as cnt FROM INFORMATION_SCHEMA.COLUMNS
                   WHERE TABLE_NAME = '$table_name'
                    ...
                    ADD CONSTRAINT redirect_from UNIQUE (redirect_from(200),cat,blog);
                ";
                    $wpdb->query($sql);
            ...
            }else
            {
                ...
                $wpdb->query("ALTER TABLE $table_name CHANGE `link` `link` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL;");
                $wpdb->query("ALTER TABLE $table_name CHANGE `referrer` `referrer` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL;");
    		...
    		CREATE TABLE IF NOT EXISTS `$table_name` (
              ...
              `ctime` datetime NOT NULL,
              `rfrom` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
              `rto` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
            ...
            {
                $wpdb->query("ALTER TABLE $table_name CHANGE `rfrom` `rfrom` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL;");
                $wpdb->query("ALTER TABLE $table_name CHANGE `referrer` `referrer` VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL;");
    		...
    		CREATE TABLE IF NOT EXISTS `$table_name` (
              ...
              `redirect_from` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
              `redirect_to` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
			...
			";
                ...
                $wpdb->query("ALTER TABLE $table_name CHANGE `redirect_from` `redirect_from` VARCHAR(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL;");
                $wpdb->query("ALTER TABLE $table_name CHANGE `redirect_to` `redirect_to` VARCHAR(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL;");
                ...
                if($wpdb->get_var(" SELECT count(*) as cnt FROM INFORMATION_SCHEMA.COLUMNS
                    ...
                    $sql="
                    ALTER TABLE $table_name
                    ADD COLUMN `redirect_from` varchar(250) COLLATE utf8_unicode_ci NOT NULL;
                ";
                    $wpdb->query($sql);
                }
            ...
            if($wpdb->get_var("show tables like '$table_name'") != $table_name) {
                ...
                CREATE TABLE IF NOT EXISTS `$table_name` (
              `ID` int(11) unsigned NOT NULL AUTO_INCREMENT,
              `group_title` varchar(250) COLLATE utf8_unicode_ci NOT NULL,
        ...
        public static function install_options($blog=0)
        {
			...
			if(!array_key_exists('never_redirect_search_res',$options))
                $options['never_redirect_search_res']= '0';
